...
export const PAPER_LIQUID_METAL_FRAGMENT = `#version 300 es
precision mediump float;
...
void main() {
  ...
  fragColor = vec4(clamp(color, vec3(0.0), vec3(opacity)), opacity);
}
`;

export const PAPER_PULSING_BORDER_FRAGMENT = `#version 300 es
...
export const PAPER_GEM_SMOKE_FRAGMENT = `#version 300 es
precision mediump float;
...
export const PAPER_HEATMAP_FRAGMENT = `#version 300 es

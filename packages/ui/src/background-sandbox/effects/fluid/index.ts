...
export const fluidDefinition: Definition<"fluid", FluidParams> = {
  ...
  label: "Fluid",
  description: "Инерционная жидкость. Рисуйте с нажатой кнопкой; после жеста среда продолжит двигаться. Touch сохраняет прокрутку.",
  schema: fluidSchema,
  presets: [

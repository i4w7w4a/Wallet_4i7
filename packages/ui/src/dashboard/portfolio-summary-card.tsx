...
export function PortfolioSummaryCard(props: { balance: WalletBalance; assets: WalletAsset[] }) {
  ...
  return (
    <section className="dashboard-card portfolio-summary" aria-label="Портфель">
      <h2>Портфель</h2>

...
Переименование GitHub-репозитория в Novex Wallet не меняет этот адрес,
Docker project `wallet-mono`, имена образов и контейнеров. Это намеренная
совместимость действующего маршрута и процедуры отката.

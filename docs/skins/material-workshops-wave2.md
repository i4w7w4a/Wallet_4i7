...
Позднейшее решение владельца от 2026-09-25: исправить замечания после просмотра и опубликовать единую сборку без повторного visual approval. Актуальная область, владельцы и условия публикации: [post-review release packet](material-workshops-wave2-release.md). Прежние запреты на публикацию ниже относятся к исходному этапу, а не отменяют новое разрешение.

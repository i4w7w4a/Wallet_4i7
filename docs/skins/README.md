...
- Все design controls вынесены из телефона в две sibling rails: слева `Варианты / Экран / Цвет`, справа `Среда / Оптика / Смысловые цвета`. Центральная `.mono-page` не содержит лабораторную шапку или control tree и остаётся чистым объектом визуальной оценки.

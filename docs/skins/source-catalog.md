...
Проверка React 19 / Next 16 / Tailwind 4 / Strict Mode относится к **нашему adapter** через тесты и локальный preview, а не к upstream-демо. До возможного переноса в продукт нужны отдельное решение владельца, review лицензионного notice и повторная примерка в настоящем контексте.
